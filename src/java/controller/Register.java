...
public class Register extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!pass.equals(repass)) {
            // Passwords don't match, send a message to the user
            request.setAttribute("message", "Mật khẩu không khớp.");
            request.getRequestDispatcher("register.jsp").forward(request, response);
        } else {
            // Passwords match, proceed to add new staff
            Staff st = new Staff(name, pass, mail, Integer.parseInt(role));
            db.addNewStaff(st);

            // Optionally, you can send a success message to the user
